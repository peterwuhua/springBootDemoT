...
public class PropertiesTools {
	...
	public static void main(String[] args) {
		/*
		 * Connection conn = JDBCTools.getConnection(); Statement st = null; try
		 * { st = conn.createStatement(); st.execute(
		 * "INSERT INTO `com_type` (`ID`,`NAME`,`CODE`,`REMARK`,`SORT`,`TENANTID`) VALUES ('295cf00322d440728c3a757ac7b4f110','样品登记','YPDJ','0','2',1090)"
		 * ); } catch (Exception x) { x.printStackTrace(); } if (null != st) {
		 * try { st.close(); } catch (SQLException e) { // TODO Auto-generated
		 * catch block //e.printStackTrace(); } }
		 */
		Set<Entry<Object, Object>> propSet = PropertiesTools
				.getPropertiesValueByFilePathAndKey("F:\\CharlesWorkspace\\Demo02\\Client\\WebRoot\\sqltemplate\\rolefun.properties");
		Iterator<?> iterator = propSet.iterator();
		while (iterator.hasNext()) {
			Entry<Object, Object> entryMap = (Entry<Object, Object>) iterator
					.next();
