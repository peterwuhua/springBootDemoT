...
public class ImageUtils {
	...
	public static String generateImage(String tempPath, String str) throws GlobalException {
		...
		try {
			...
			String formatName = returnImagePath.substring(returnImagePath.lastIndexOf(".") + 1);  
		    ImageIO.write(bufferedImage, /*"GIF"*/ formatName /* format desired */ , new File(returnImagePath) /* target */ );  
