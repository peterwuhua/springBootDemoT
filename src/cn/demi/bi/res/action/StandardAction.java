...
@Controller("bi.standardAction")
@RequestMapping("/bi/standard")
public class StandardAction extends BaseAction<StandardVo> {
	final String VIEW_PATH = "/bi/standard/standard";
	...
	public ModelAndView selectSeachValue(String pageType,String pageValue,String inputValue) throws GlobalException{
		...
		List<String> list = standardService.selectByPageType(pageType);
	...
	/**
	 * Create on : Dave Yu 2017年1月23日 下午3:01:32 <br>
	...
	public ModelAndView seeData(StandardVo v) throws GlobalException {
		ModelAndView mav = new ModelAndView();
		mav.addObject(VO, v);
	...
	public Map<String, Map<String, Integer>> ajaxSeachStates(StandardVo vo) throws GlobalException {
		...
		List<Object> reagentList = standardService.MaxPayTenStandard(vo);
	...
	public ResponseEntity<byte[]> exportOther(StandardVo v,PageResult pageResult,
	 ...
	 * @throws GlobalException
	 */
	private Map<String, Object> getExportData(StandardVo vo,PageResult pageResult,String type) throws GlobalException{
