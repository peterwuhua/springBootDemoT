...
@Controller("bi.reagentAction")
@RequestMapping("/bi/reagent")
public class ReagentAction extends BaseAction<ReagentVo> {
	final String VIEW_PATH = "/bi/reagent/reagent";
	...
	public ModelAndView selectSeachValue(String pageType,String pageValue,String inputValue) throws GlobalException{
		...
		List<String> list = reagentService.selectByPageType(pageType);
	...
	/**
	 * Create on : Dave Yu 2017年1月23日 下午3:00:30 <br>
	 * Description : 数据查看页面跳转方法 <br>
	 * @param v
	 * @return mav
	 * @throws GlobalException
	 */
	@RequestMapping(value="seeData.do")
	public ModelAndView seeData(ReagentVo v) throws GlobalException {
		ModelAndView mav = new ModelAndView();
		mav.addObject(VO, v);
	...
	public Map<String, Map<String, Integer>> ajaxSeachStates(ReagentVo vo) throws GlobalException {
		...
		List<Object> reagentList = reagentService.MaxPayTenReagent(vo);
		for (int i = 0; i < reagentList.size(); i++) {
			...
			if(String.valueOf(Object[2]).indexOf(".") > -1){
				...
				if(null != Object[2] &&  !"".equals(String.valueOf(Object[2]))){
					sjMap.put(String.valueOf(Object[0]), Integer.valueOf(String.valueOf(Object[2])));
				}
			}
		}
	...
	public ResponseEntity<byte[]> exportOther(ReagentVo v,PageResult pageResult,
	 ...
	 * @throws GlobalException
	 */
	private Map<String, Object> getExportData(ReagentVo vo,PageResult pageResult,String type) throws GlobalException{
