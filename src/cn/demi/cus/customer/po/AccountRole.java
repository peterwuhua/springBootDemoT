...
@Entity(name = "cus_account_role")
@Table(name = "cus_account_role")
@Module(value = "cus.account_role")
...
public class AccountRole extends Po<AccountRole> {
	...
	public static void main(String[] args) {
		CreateCodeUtils.autoCreateCode(AccountRole.class, true, ActionType.JSP);
	}
}
