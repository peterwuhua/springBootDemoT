...
@Module(value="sys.email")
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class Email extends Po<Email>{
	private static final long serialVersionUID = 1L;
	/**
	 * 对象转换为map时，需要转换的属性
	 */
	public String[] PROPERTY_TO_MAP= {"id","sort","subject","type","remark","receiver","content","status","busType","busInfo","busId","result","sendTime"};
	/**
	 * 主题
	 */
