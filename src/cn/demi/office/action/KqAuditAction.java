 ...
 *
 */
@Controller("office.kqAuditAction")
@RequestMapping("/office/kqAudit")
public class KqAuditAction extends BaseAction<KqVo> {
	final String VIEW_PATH = "/office/kq_audit/kq_audit";
	@Autowired 
