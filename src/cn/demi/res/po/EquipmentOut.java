 ...
 *
 */
@Entity(name = "res_equipment_out")
@Table(name = "res_equipment_out")
@Module(value = "res.equipmentOut")
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class EquipmentOut extends Po<EquipmentOut>{
	...
	public String[] PROPERTY_TO_MAP= {"id","sort","equipt","useName","useTime","mobile","appStatus","status","cyNames"};
	@Override
	@Transient
	...
	public static void main(String[] args) {
		CreateCodeUtils.autoCreateCode(EquipmentOut.class, false, ActionType.JSP);
	}
