 ...
 */
@Entity(name = "res_stanOutIn")
@Table(name = "res_stanOutIn")
@Module(value = "res.stanOutIn")
public class StanOutIn extends Po<StanOutIn> {
	 ...
	 * 对象转换为map时，需要转换的属性
	 */
	public String[] PROPERTY_TO_MAP= {"id","no","cas","cerNo","name","ename","safeAmount","amount","unit","rule","content","user","dep","supplier","mfg","exp",
			"remark","state","price","saveCondition","producer","leadingPerson","leadingDate","leadingNum","inPerson","inDate","inNum","status","standard"};
	...
	public static void main(String[] args) {
		CreateCodeUtils.autoCreateCode(StanOutIn.class, false, ActionType.JSP);
	}
	@Transient
	@Override
