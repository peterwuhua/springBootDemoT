 ...
 *
 */
@Entity(name = "res_appara_in")
@Table(name = "res_appara_in")
@Module(value = "res.apparaIn")
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class ApparaIn extends Po<ApparaIn>{
	...
	public String[] PROPERTY_TO_MAP= {"id","sort","appara","order","useName","useTime","mobile","appStatus","status","duration"};
	@Override
	@Transient
	...
	public ApparaOut getOut() {
		return out;
	}
	public void setOut(ApparaOut out) {
		this.out = out;
	}
	@Column(length = 32)
	...
	public static void main(String[] args) {
		CreateCodeUtils.autoCreateCode(ApparaIn.class, false, ActionType.JSP);
	}
}
