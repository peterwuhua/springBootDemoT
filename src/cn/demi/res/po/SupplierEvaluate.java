...
@Entity(name = "res_supplier_evaluate")
@Table(name = "res_supplier_evaluate")
@Module(value="res.supplier.evaluate")
public class SupplierEvaluate extends Po<SupplierEvaluate> {
	
	private static final long serialVersionUID = 1L;
	private Supplier supplier;//供应商
	private String tradeName;//商品名称
	private String supTime;//供应时间
	 ...
	 * 对象转换为map时，需要转换的属性
	 */
	public String[] PROPERTY_TO_MAP= {"id","supplier","supTime","evaluateTime","evaluatePerson","price","deliveryTime","productQuality","serviceQuality","content","filePath","fileName","tradeName"};
