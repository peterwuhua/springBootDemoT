 ...
 */
@Entity(name = "res_reagent")
@Table(name = "res_reagent")
@Module(value = "res.reagent")
public class Reagent extends Po<Reagent> {
	 ...
	 * 对象转换为map时，需要转换的属性
	 */
	public String[] PROPERTY_TO_MAP= {"name","ename","sname","grade","type","safeAmount","amount","no","unit","rule","keeper","deptName","supplier","mfg","exp",
			"remark","state","price","id","saveCode","purpose","purity"};
