 ...
 * @author QuJunLong
 */
@Entity(name = "res_appara_used")
@Table(name = "res_appara_used")
@Module(value="res.apparaUsed")
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class ApparaUsed extends Po<ApparaUsed>{
	 
	private static final long serialVersionUID = 1L;
	public String[] PROPERTY_TO_MAP = {"id","sort","appara","appStat","startTime","endTime","duration","orgName","userName","purpose"};
	@Override
	@Transient
