...
//            });
            // 添加选项卡
           /* if(iframe()>10){
            	 var activeId = $('.J_menuTab').prev('.J_menuTab:last').data('id');
                 $('.J_menuTab').prev('.J_menuTab:last').next('.J_menuTab').addClass('active');
                $('.J_mainContent .J_iframe').each(function () {
            	...
            	alert('打开窗口过多、页面会比较卡顿、请尝试关闭一些窗口');
            }else{
    ...
    //点击页面选项卡标签的关闭图标（fa fa-times-circle）触发的
