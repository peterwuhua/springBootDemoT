...
<body class="gray-bg">
	...
	$(function() {
		var url = '${basePath}qlt/gs/gridData4Record.do';
	...
	function gridComplete() {
		...
		for (var i = 0; i < ids.length; i++) {
			...
			be = '<a class="btn btn-outline btn-success btn-xs" title="编辑" href="javascript:openEditPage(\'edit.do?gsVo.id='+ids[i]+'\')">编辑</a>';
