...
<body class="gray-bg">
	...
	$(function() {
		var url = 'gridData.do';
		var colNames = ['单号 ','客户名称','回访人','电话','拜访日期','拜访人','状态','操作'];
		var colModel = [
			 {
				name : 'no',
				index : 'no',
	...
	function loadComplete(data) {
		...
		for (var i = 0; i < ids.length; i++) {
			...
			var be='';
			if(rData.status=='1'){
				be = '<a class="btn btn-outline btn-success btn-xs" title="回访" href="javascript:fnEdit(\'edit.do?id='+ rData.id+'\');">回访</a>';
			}else{
