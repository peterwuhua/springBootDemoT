						...
						<tr>
							...
							<td>
								<div class="input-group">
									<input id="gzName" name="gzName" value="${vo.gzName}" class="form-control required" validate="required" type="text"  onclick="fnSelectGz()"/>
							...
							<td>
								<div class="input-group date">
	                              	<input id="gzDate" name="gzDate" class="form-control required dateISO" validate="required" type="text" value="${vo.gzDate}" />
									...
									<c:choose>
										<c:when test="${e1.subList!=null && fn:length(e1.subList)>0}">
											<c:forEach items="${e1.subList}" var="e2" varStatus="v2">
												<tr>
													...
													<td>
														<input type="text" name="detailList[${v.index}].subList[${v1.index}].subList[${v2.index}].rectification" value="${e2.rectification}"  class="form-control required" validate="required">
													</td>
												</tr>
											</c:forEach>
										</c:when>
										<c:otherwise>
											<tr>
												...
												<td>
													<input type="text" name="detailList[${v.index}].subList[${v1.index}].rectification" value="${e1.rectification}"  class="form-control required" validate="required">
												</td>
											</tr>
										</c:otherwise>
									</c:choose>
