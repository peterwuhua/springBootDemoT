						...
						<tr>
							...
							<td>
								<div class="input-group">
									<input id="yzName" name="yzName" value="${vo.yzName}" class="form-control" type="text"  onclick="fnSelectGz()"/>
									<input id="yzId" name="yzId" value="${vo.yzId}" type="hidden"/>
							...
							<td>
								<div class="input-group date">
	                              	<input id="yzDate" name="yzDate" class="form-control required dateISO" validate="required" type="text" value="${vo.yzDate}" />
...
<script>
	...
	function fnSelectGz(){
		...
		layer.open({
			...
			fix: false, //不固定
			maxmin: true,
			content: '${basePath}sys/account/selects.do?ids='+yzId,
			btn: ['确定','取消'], //按钮
