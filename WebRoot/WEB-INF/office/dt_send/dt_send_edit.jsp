	...
	<div class="col-sm-12">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<ol class="breadcrumb">
					<li><a href="javascript:backMainPage();">文件下发</a></li>
					<li><strong>编辑</strong>
					</li>
				</ol>
			</div>
					 ...
					 <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							<tr>
								...
								<td>
									<input class="form-control" id="sendCt" type="text" value="${vo.sendCt}" name="sendCt"/>
								</td>
								<td class="active"><label class="pull-right">指&nbsp;定&nbsp;&nbsp;人:</label></td>
								<td>
									<div class="input-group">
										<input id="userNames" name="userNames" class="form-control required" validate="required" type="text" value="${vo.userNames}" onclick="fnSelectUser()"/>
							...
							<tr>
								...
								<td>
									<input readonly="readonly" id="sendName" name="sendName" class="form-control " type="text" value="${vo.sendName}" />
									<input  id="sendId" name="sendId" type="hidden" value="${vo.sendId}" />
								</td>
								<td class="active"><label class="pull-right">下发日期:</label></td>
								<td>
									<div class="input-group date">
		                           		<input id="sendTime" name="sendTime" class="form-control required datetimeISO" validate="required" type="text" value="${vo.sendTime}" />
