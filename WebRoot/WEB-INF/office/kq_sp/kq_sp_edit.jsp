	...
	<div class="col-sm-12">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<ol class="breadcrumb">
					<li><a href="javascript:backMainPage();">总经理审核</a></li>
					<li><strong>编辑</strong>
					</li>
				</ol>
			</div>
					 ...
					 <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							<tr>
								...
								<td colspan="3">
									<textarea rows="2" class="form-control" id="spMsg" placeholder="" name="spMsg">${vo.spMsg}</textarea>
								</td>
							</tr>
							<tr>
								<td class="active"><label class="pull-right">审&nbsp;&nbsp;核&nbsp;人:</label></td>
								<td>
									<input readonly="readonly" id="spName" name="spName" class="form-control " type="text" value="${vo.spName}" />
									<input  id="spId" name="spId" type="hidden" value="${vo.spId}" />
								</td>
								<td class="active"><label class="pull-right">审核日期:</label></td>
								<td>
									<div class="input-group date">
		                           		<input id="spDate" name="spDate" class="form-control required datetimeISO" validate="required" type="text" value="${vo.spDate}" />
