...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				...
				<div class="pull-right">
		                <div class="btn-group">
		                    <a type="button" class="btn btn-xs btn-success active"    >当天之后的记录</a>
		                    <a type="button" class="btn btn-xs btn-outline btn-default" href="${basePath}office/qjcy/gridPaged.do">历史记录</a>
		                </div>
	            </div>
			</div>
	...
	function fnShow(id){
		var index = layer.open({
			...
			fix: false, //不固定
			maxmin: true,
			content: '/office/qjcy/show.do?id='+id
		});
	}
