		...
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				...
				<div class="pull-right">
		                <div class="btn-group">
		                    <a type="button" class="btn btn-xs btn-outline btn-default"  href="${basePath}office/qjcy/gridPage.do">当天之后的记录</a>
		                    <a type="button" class="btn btn-xs btn-success active"  >历史记录</a>
		                </div>
	            </div>
			</div>
