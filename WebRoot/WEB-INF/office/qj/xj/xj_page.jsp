...
<body class="gray-bg">
			...
			<div class="ibox-title">
				...
				<div class="pull-right">
		                <div class="btn-group">
		                    ...
		                    <a type="button"  class="btn btn-xs btn-outline btn-default" href="${basePath}office/xj/gridPaged.do">已提交的记录</a>
		                </div>
	            </div>
			</div>
	...
	function gridComplete() {
		...
		for (var i = 0; i < ids.length; i++) {
			...
			be = ' <a class="btn btn-outline btn-success btn-xs" title="销假" href="javascript:fnUpdate(\'updateStatus.do?id='+cl+'\')">销假</a>';
