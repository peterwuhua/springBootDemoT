...
<body class="gray-bg">
			...
			<div class="ibox-title">
				...
				<div class="pull-right">
		                <div class="btn-group">
		                    ...
		                    <a type="button"  class="btn btn-xs btn-outline btn-default" href="${basePath}office/qjsp/gridPaged.do">已提交的记录</a>
		                </div>
	            </div>
			</div>
	...
	function fnShow(id){
		var index = layer.open({
			...
			fix: false, //不固定
			maxmin: true,
			content: '/office/qjsp/show.do?id='+id
		});
	}
	function fnDel(id){
	...
	function gridComplete() {
		...
		for (var i = 0; i < ids.length; i++) {
			...
			be = ' <a class="btn btn-outline btn-success btn-xs" title="审批" href="javascript:openEditPage(\'edit.do?id='+ids[i]+'\')">审批</a>';
