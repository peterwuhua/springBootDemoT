	...
	<div class="col-sm-12">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<form action="gridPage4Execut.do" method="post" id="listForm">
	...
	$(function() {
		...
		function gridComplete() {
			...
			for (var i = 0; i < ids.length; i++) {
				var cl = ids[i];
				be = '<a class="btn btn-outline btn-success btn-xs" title="修改" href="javascript:openEditPage(\'edit.do?flag=2&id='+ids[i]+'\')">修改</a>';
