              ...
              <div class="ibox-content">
                  <form method="post" action="import.do" class="form-horizontal" enctype="multipart/form-data">
                      ...
                      <div class="alert alert-warning">
                       	请先下载 <a href="downtemp.do?type=import&templateName=cus-contract-detail-import.xls&trueName=合同参数信息导入模板.xls" class="btn btn-w-m btn-primary">模板文件</a>，填充数据后再做导入
                   </div>
