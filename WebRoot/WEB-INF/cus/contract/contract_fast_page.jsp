...
<body class="gray-bg">
			...
			<div class="ibox-title">
				...
				<div class="pull-right">
					<div class="btn-group">
						...
						<a type="button" class="btn btn-xs btn-success active">快到期合同</a> 
	...
	<script>
		$(function() {
			var url = 'gridData4Fast.do';
			var colNames = [ '合同编号 ', '客户名称', '合同名称 ', '开始日期', '结束日期', '优惠折扣',
					'合同金额', '执行状态', '操作' ];
			var colModel = [ {
				name : 'code',
				index : 'code',
		...
		function gridComplete() {
			...
			for (var i = 0; i < ids.length; i++) {
				var cl = ids[i];
				be = '<a class="btn btn-outline btn-success btn-xs" title="修改" href="javascript:openEditPage(\'edit.do?flag=4&id='+ ids[i] + '\')">修改</a>';
