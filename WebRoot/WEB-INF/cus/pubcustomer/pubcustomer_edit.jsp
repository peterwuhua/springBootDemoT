					...
					<div class="panel-heading">
						<div class="panel-options">
							<ul class="nav nav-tabs">
								...
								<li><a onmousedown="checkSave();" href="#" onclick="location.href='${basePath}cus/contacts/gridTab4PubCust.do?customerVo.id=${vo.id}'" data-toggle="tab">联系人</a></li>
								<%-- <li><a onmousedown="checkSave();" href="#" onclick="location.href='${basePath}cus/custPoint/gridTab.do?customerVo.id=${vo.id}'" data-toggle="tab">监测点位</a></li> --%>
								<li><a onmousedown="checkSave();" href="#" onclick="location.href='${basePath}cus/saleContact/gridPage4PubCus.do?customerId=${vo.id}'" data-toggle="tab">客户跟踪记录</a></li>
							</ul>
						</div>
					</div>
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							...
							<tr>
								...
								<td class="width-35">
									<div class="input-group date">
										<input id="buildDate" name="buildDate"  class="form-control dateISO" placeholder="建立日期" type="text" value="${vo.buildDate }" />
							...
							<tr>
								...
								<td class="active"><label class="pull-right">客户属性:</label></td>
								<td>
									<select id="cusType" name="cusType" class="form-control"></select>
								</td>
							</tr>
							<tr>
								...
								<td class="width-35">
									<div class="input-group">
											<input type="text" id="saler" name="saler" class="form-control required" validate="required" placeholder="请选择人员" value="${vo.saler}" onclick="fnSelectUser()"> 
											<input type="hidden" id="salerId" name="salerId" value="${vo.salerId}">
											<div class="input-group-btn">
