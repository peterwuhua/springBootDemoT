...
<body class="gray-bg">
               ...
               <div class="panel-options">
				<ul class="nav nav-tabs">
				   ...
				   <li><a href="javascript:;" onclick="location.href='${basePath}cus/contacts/gridTab.do?customerVo.id=${vo.customerVo.id}'" data-toggle="tab">联系人</a></li>
				    <li class="active"><a href="javascript:;" data-toggle="tab">受检单位</a></li>
	...
	<script>
	$(function() {
		var url = '/cus/cusClient/gridData4Tab.do?customerVo.id=${vo.customerVo.id}';
		var editurl='/cus/cusClient/gridEdit.do?customerVo.id=${vo.customerVo.id}';
		var colNames = ['操作','受检单位名称','所属行业','受检单位地址','联系人','电话','邮箱'];
		var colModel = [
			 {
				name : 'act',
				index : 'act',
				...
				name : 'clientVo.industry',
				index : 'client.industry',
				editable : false,
				resizable : true,
				width : 150,
				searchoptions : {
