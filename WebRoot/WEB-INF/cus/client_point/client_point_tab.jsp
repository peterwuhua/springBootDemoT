...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
					...
					<div class="panel-options">
						<div class="col-sm-6">
							<ul class="nav nav-tabs">
								<li><a href="#" onclick="location.href='${basePath}cus/client/edit.do?id=${vo.clientVo.id}'" data-toggle="tab"> 单位信息 </a></li>
				...
				<form action="${basePath}cus/contacts/gridTab.do" method="post" id="listForm">
				 <input type="hidden" value="${vo.clientVo.id}" id="clientId" name="clientVo.id" />
	...
	<script>
		$(function() {
			var url = '${basePath}cus/clientPoint/gridData4Tab.do?clientVo.id=${vo.clientVo.id}';
			var colNames = [ '大类', '车间/工作场所', '监测点位', '点位代码','监测项目','备注','操作'];
			var colModel = [
				{
				name : 'sampType',
				index : 'sampType',
...
function fnEidt(parm){
	...
	layer.open({
		...
		fix: false, //不固定
		maxmin: true,
		content: 'editTab.do?id='+id+'&clientVo.id=${vo.clientVo.id}',
		btn: ['确定','取消'], //按钮
