...
<body class="gray-bg">
			  ...
			  <div class="panel-heading">
               <div class="panel-options">
					<ul class="nav nav-tabs">
					    <li><a href="javascript:;" onclick="location.href='${basePath}cus/customer/edit.do?id=${vo.customerVo.id}'" data-toggle="tab"> 客户信息</a></li>
					    ...
					    <li><a href="javascript:;" data-toggle="tab"  onclick="location.href='${basePath}cus/cusClient/gridTab.do?customerVo.id=${vo.customerVo.id}'" >受检单位</a></li>
					    <li class="active"><a href="javascript:;" data-toggle="tab">生产单位</a></li>
				...
				<div class="col-sm-7">
					...
					<div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                              <li><a href="javascript:;" onclick="jqgridExport('cus-produce-export.xls','生产单位信息列表.xls',0)" >全部数据</a>
                              </li>
                              <li><a href="javascript:;" onclick="jqgridExport('cus-produce-export.xls','生产单位信息列表.xls',1)" >选中数据</a>
                              </li>
                          </ul>
                      </div>
	...
	<script>
	$(function() {
		var url = '/cus/cusProduce/gridData4Tab.do?customerVo.id=${vo.customerVo.id}';
		var editurl='/cus/cusProduce/gridEdit.do?customerVo.id=${vo.customerVo.id}';
		var colNames = ['操作','生产单位名称','所属行业','生产单位地址','联系人','电话','邮箱'];
		var colModel = [ 
               {
   				name : 'act',
   				index : 'act',
				...
				name : 'produceVo.industry',
				index : 'produce.industry',
				editable : true,
				resizable : true,
				width : 150,
				searchoptions : {
				...
				name : 'produceVo.address',
				index : 'produce.address',
				editable : true,
				resizable : true,
				width : 200,
				searchoptions : {
				...
				name : 'produceVo.person',
				index : 'produce.person',
				editable : true,
				resizable : true,
				width : 150,
				searchoptions : {
