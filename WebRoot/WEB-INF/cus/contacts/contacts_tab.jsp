					...
					<div class="panel-options">
						<div class="col-sm-6">
							<ul class="nav nav-tabs">
								...
								<li><a href="#" onclick="location.href='${basePath}cus/saleContact/gridPage4Cus.do?customerId=${vo.customerVo.id}&salerId=${vo.customerVo.salerId}'" data-toggle="tab">客户跟踪记录</a></li>
							</ul>
						</div>
