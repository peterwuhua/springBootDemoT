					...
					<div class="panel-options">
						<div class="col-sm-6">
							<ul class="nav nav-tabs">
								<li><a href="#" onclick="location.href='${basePath}cus/pubcustomer/edit.do?id=${vo.customerVo.id}'" data-toggle="tab"> 客户信息 </a></li>
								<li class="active"><a href="#" data-toggle="tab">联系人</a></li>
								<li><a href="#" onclick="location.href='${basePath}cus/saleContact/gridPage4PubCus.do?customerId=${vo.customerVo.id}'" data-toggle="tab">客户跟踪记录</a></li>
							</ul>
						</div>
