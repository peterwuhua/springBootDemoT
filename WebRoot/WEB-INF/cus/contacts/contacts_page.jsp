...
<body class="gray-bg">
				...
				<div class="col-sm-7">
					...
					<div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                              <li><a href="javascript:;" onclick="jqgridExport('cus-contacts-export.xls','联系人信息列表.xls',0)" >全部数据</a>
                              </li>
                              <li><a href="javascript:;" onclick="jqgridExport('cus-contacts-export.xls','联系人信息列表.xls',1)" >选中数据</a>
                              </li>
                          </ul>
                      </div>
				</div>
	...
	$(function() {
		...
		var colNames = ['操作','客户名称','联系人名称','部门','职务','地址','电话','邮箱'];
		var colModel = [
			  {
				name : 'act',
				index : 'act',
