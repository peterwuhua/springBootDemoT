...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				...
				<div class="pull-right">
	                <div class="btn-group">
	                    <a type="button" class="btn btn-xs btn-outline btn-default" href="${basePath}cus/bill/auditPage.do">未提交的记录</a>
	                    <a type="button" class="btn btn-xs btn-success active"  >已提交的记录</a>
	                </div>
            	</div>
			</div>
			<div class="ibox-content">
				<form action="auditPage4tgPage.do" method="post" id="listForm">
	...
	$(function() {
		var url = '/cus/bill/auditPage4success.do';
