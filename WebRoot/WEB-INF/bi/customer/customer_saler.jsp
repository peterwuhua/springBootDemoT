					...
					<div id="tab-2" class="tab-pane">
                   		<div class="panel-body">
                             <form action="" method="post" id="listForm">
								...
								<input type="hidden" name="disPage" id="disPage" value="saler">
								<div class="col-sm-9">
									<button class="btn btn-info" href="javascript:;" onclick="jqgridExportOther('exportOther.do','bi-customer-saler-export.xls','所属客户统计.xls',0)">导出</button>
								</div>
