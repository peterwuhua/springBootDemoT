					...
					<div id="tab-2" class="tab-pane">
                   		<div class="panel-body">
                             <form action="" method="post" id="listForm">
								...
								<input type="hidden" name="disPage" id="disPage" value="industry">
								<div class="col-sm-9">
									<button class="btn btn-info" href="javascript:;" onclick="jqgridExportOther('exportOther.do','bi-customer-industry-export.xls','客户行业统计.xls',0)">导出</button>
								</div>
...
//刷新echarts
function refreshData(industry,num){
	if(!myChart){
		return;
	}
	//更新数据
	...
	for (var i = 0; i < industry.length ; i++){
		...
		dataList.push(industryList);
	}
	option.series[0].data = dataList;
	option.legend[0].data = industry;
...
function seeData(industry){
	layer.open({
		type: 2,
		area: ['800px', '600px'],
		fix: false, //不固定
		maxmin: true,
		content: 'seeData.do?industry='+industry+'&souce='+$('#souce').val()+'&saler='+$('#saler').val()+'&customerType='+$('#customerType').val()
