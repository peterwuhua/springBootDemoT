...
<body class="gray-bg">
				...
				<div>
					...
					<div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                              <li><a href="javascript:;" onclick="jqgridExportOther('/res/stanoutin/exportOutData.do','res-stanout-export.xls','试剂出库信息.xls',0)">全部数据</a></li>
                              </li>
                              <li><a href="javascript:;" onclick="jqgridExportOther('/res/stanoutin/exportOutData.do','res-stanout-export.xls','试剂出库信息.xls',1)">选中数据</a></li>
                              </li>
                          </ul>
                     </div>
				</div>
	...
	$(function() {
		var url = 'outData.do';
		var colNames = ['编号 ','名称 ','规格型号','有效期至','领用人','领取时间','领取数量','备注'];
		var colModel = [
			  {
				name : 'standardVo.no',
				index : 'standard.no',
