                ...
                <div class="ibox float-e-margins">
                   <div class="ibox-title">
                    ...
                    <div class="ibox-content">
                        ...
                        <form method="post" action="/res/stanoutin/addOutDepot.do" class="form-horizontal" enctype="multipart/form-data" id="thisForm">
									...
									<tr>	
										...
										<td class="width-35">
											<div class="input-group" style="width: 100%">
												<input id="standardName" class="form-control required" validate="required" name="standardVo.name" type="text" value="${vo.standardVo.name }"  onclick="fnSelect()"/>
												 <input id="standardId" name="standardVo.id" value="${vo.standardVo.id}" type="hidden" />
										...
										<td class="width-35"><input id="standardNo" class="form-control" name="standardVo.no" type="text" value="${vo.standardVo.no}" readonly="readonly"/></td>
									</tr>
									<tr>	
										<td class="width-15 active"><label class="pull-right">规格型号:</label></td>
										<td class="width-35"><input id="rule"  class="form-control"  type="text" name="standardVo.rule" value="${vo.standardVo.rule} " readonly="readonly"/></td>
										<td class="width-15 active"><label class="pull-right">当前库存:</label></td>
										<td class="width-35"><input id="amount"  class="form-control"  type="text" name="standardVo.amount" value="${vo.standardVo.amount} " readonly="readonly"/></td>
									</tr>
									<tr>	
