                ...
                <div class="ibox float-e-margins">
                   <div class="ibox-title">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="addOutDepot.do" class="form-horizontal" enctype="multipart/form-data">
							 ...
							 <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
								<tbody>
									<tr>	
										...
										<td class="width-35"><input id="leadingPerson" placeholder="请输入领用人"  class="form-control" name="leadingPerson" type="text" value="${vo.leadingPerson }"/></td>
										<td class="width-15 active"><label class="pull-right">领用时间:</label></td>
										<td class="width-35"><input id="leadingDate" placeholder="请输入领用日期"   class="form-control dateISO" name="leadingDate" type="text" value="${vo.leadingDate }"/></td>
									</tr>
									<tr>	
										<td class="width-15 active"><label class="pull-right">领用数量:</label></td>
										<td class="width-35"><input id="leadingNum" placeholder="请输入领用数量"  class="form-control number" name="leadingNum" type="text" value="${vo.leadingNum }"/></td>
									</tr>
								</tbody>
							</table>
