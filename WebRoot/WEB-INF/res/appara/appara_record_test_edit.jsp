			...
			<div class="ibox-content">
				<form id="thisForm" method="post" action="${fn:length(vo.id)>0? 'update2File.do':'add2File.do'}" class="form-horizontal" enctype="multipart/form-data">
					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							<tr>
								<th class="width-15 active"><label class="pull-right">检&nbsp;&nbsp;定&nbsp;人:</label></th>
								<td class="width-35">
								...
								<th class="width-15 active"><label class="pull-right">检定日期:</label></th>
								<td class="width-35">
							...
							<tr>
								...
								<td class="active"><label class="pull-right">检定总结论:</label></td>
							...
							<tr>
								...
								<td colspan="2"><a href="download.do?filePath=${vo.fileUrl}&trueName=${vo.trueName}">${vo.trueName}</a></td>
							</tr>
						</tbody>
					</table>
				</form>
