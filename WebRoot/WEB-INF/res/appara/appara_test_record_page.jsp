...
<body class="gray-bg">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				...
				<div class="pull-right">
	                <div class="btn-group">
	                    <a type="button" class="btn btn-xs btn-success active" >待检定列表</a>
	                    <a type="button" class="btn btn-xs btn-outline btn-default" onclick="location.href='/res/apparaRecord/gridPage.do?type=test'">已检定列表</a>
	                </div>
	            </div>
			</div>
	...
	$(function() {
		var url = '/res/appara/gridData4type.do?type=test';
