...
<body class="gray-bg">
				...
				<div>
					...
					<div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                              <li><a href="javascript:;" onclick="jqgridExportOther('/res/consoutin/exportInData.do','res-consin-export.xls','耗材入库信息.xls',0)">全部数据</a></li>
                              </li>
                              <li><a href="javascript:;" onclick="jqgridExportOther('/res/consoutin/exportInData.do','res-consin-export.xls','耗材入库信息.xls',1)">选中数据</a></li>
                              </li>
                          </ul>
                     </div>
				</div>
	...
	$(function() {
		var url = 'inData.do';
		var colNames = ['编号 ','名称 ','类型','单位','型号','操作人','入库时间','入库数量','备注'];
		var colModel = [
	  			 {
