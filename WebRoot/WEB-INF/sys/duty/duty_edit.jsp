	...
	<div class="col-sm-12">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<ol class="breadcrumb">
					<li><a href="javascript:backMainPage();">岗位</a></li>
				...
				<form method="post" action="${fn:length(vo.id)>0? 'updateData.do':'addData.do'}" class="form-horizontal" id="thisForm">
					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							<tr>
								...
								<td class="width-35"><input id="name" placeholder="名称" maxlength=64 class="form-control required" validate="required" name="name" type="text" value="${vo.name}" /></td>
					...
					<div class="form-group">
						<div class="col-sm-12 col-sm-offset-1">
							...
							<button class="btn btn-w-m btn-primary" type="button" onclick="formSubmit('${fn:length(vo.id)>0? 'updateData.do':'addData.do'}');">
