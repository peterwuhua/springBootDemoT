...
//打开Word文档
if(tempPath.endsWith(".doc")||tempPath.endsWith(".docx")){
	poCtrl.webOpen(request.getContextPath()+"/"+tempPath, OpenModeType.docReadOnly, "");
}else if(tempPath.endsWith(".xls")||tempPath.endsWith(".xlsx")){
	poCtrl.webOpen(request.getContextPath()+"/"+tempPath, OpenModeType.xlsReadOnly, "");
}else if(tempPath.endsWith(".ppt")||tempPath.endsWith(".pptx")){
	poCtrl.webOpen(request.getContextPath()+"/"+tempPath, OpenModeType.pptReadOnly, "");
}
