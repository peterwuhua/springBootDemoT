...
<body class="gray-bg">
	<div class="row">
		<div class="col-sm-2">
			<jsp:include page="message_left.jsp?flag=draft" />
		</div>
		<div class="col-sm-10">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<div class="mail-tools tooltip-demo m-t-md">
						...
						<form method="post" action="draft.do" class="pull-right mail-search">
							...
							<tbody>
								<c:forEach items="${list}" var="e">
									<tr class="read">
										...
										<td class="mail-ontact" title="${e.reciver}"><a href="messageAnswer.do?id=${e.id}&flag=draft">${fn:substring(e.reciver,0,60)}</a>
										<td class="mail-subject"><a href="messageAnswer.do?id=${e.id}&flag=draft">${e.subject}</a></td>
										</td>
	...
	<script>
		...
		function fnDrop() {
			...
			$('form').attr('action', 'drop.do?from=draft');
			$('form').submit();
		}
	</script>
</body>
