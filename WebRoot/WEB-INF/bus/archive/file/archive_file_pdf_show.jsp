...
// Create custom toolbar
    ...
    poCtrl1.addCustomToolButton("-", "", 0);
    poCtrl1.setJsFunction_AfterDocumentOpened("SetPageReal");
    String tempPath = (String)request.getAttribute("tempPath"); 
   /*  String serverPath =(String)request.getSession().getAttribute("fileServer");  */
    poCtrl1.webOpen(basePath+tempPath);
