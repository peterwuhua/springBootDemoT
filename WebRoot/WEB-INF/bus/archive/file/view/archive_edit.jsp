					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
					 <tbody>
							...
							<tr>
								...
								<td colspan="3">
									<textarea id="confirmCt" maxlength="128" class="form-control" name="confirmCt" readonly="readonly">${vo.confirmCt}</textarea>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<div class="input-group">
										<input id="viewer" name="viewer" class="form-control "  type="text" value="${vo.viewer}" readonly="readonly" />
								...
								<td>
									<div class="input-group date">
		                           		<input id="viewTime" name="viewTime" class="form-control required datetimeISO" validate="required" type="text" value="${vo.viewTime}" />
		                            	<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		                            </div>
								</td>
							</tr>	
							<tr>	
								<td class="active"><label class="pull-right">查阅意见:</label></td>
								<td colspan="3">
									<textarea id="viewCt" maxlength="128" class="form-control" name="viewCt" >${vo.viewCt}</textarea>
								</td>
							</tr>	
					</table>
