					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
					 <tbody>
							...
							<tr>
								...
								<td>
									<input class="form-control" maxlength="128" id="confirmCt" type="text" value="${vo.confirmCt}" name="confirmCt"/>
								</td>
								<td class="active"><label class="pull-right">查&nbsp;&nbsp;阅&nbsp;人:</label></td>
								<td>
									<div class="input-group">
										<input id="viewer" name="viewer" class="form-control"  type="text" value="${vo.viewer}" onclick="fnSelectUser()"/>
							...
							<tr>
								...
								<td class="width-35">
									<input id="confirm" name="confirm" class="form-control required" validate="required" type="text" value="${vo.confirm}" readonly="readonly"/>
								...
								<td>
									<div class="input-group date">
		                           		<input id="confirmTime" name="confirmTime" class="form-control required datetimeISO" validate="required" type="text" value="${vo.confirmTime}" />
