					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
					 <tbody>
							...
							<tr>
								...
								<td class="width-15 active"><label class="pull-right">确认日期:</label></td>
								<td class="width-35">
		                           		${vo.confirmTime}
								</td>
							</tr>
							<tr>
								<td class="width-15 active"><label class="pull-right">查&nbsp;&nbsp;阅&nbsp;人:</label></td>
								<td class="width-35">
										${vo.viewer}
										<input id="viewerId" name="viewerId" type="hidden" value="${vo.viewerId}" />
								</td>
								<td class="width-15 active"><label class="pull-right">查阅日期:</label></td>
								<td class="width-35">
		                           		${vo.viewTime}
								</td>
							</tr>	
							<tr>	
								...
								<td colspan="3">
									<textarea id="viewCt" maxlength="128" class="form-control" name="viewCt" readonly="readonly">${vo.viewCt}</textarea>
								</td>
							</tr>	
					</table>
