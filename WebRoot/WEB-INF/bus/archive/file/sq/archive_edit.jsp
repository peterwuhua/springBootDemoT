				...
				<form id="thisForm" method="post" action="${fn:length(vo.id)>0? 'update4Data.do':'add4Data.do'}" class="form-horizontal" enctype="multipart/form-data">
					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							...
							<tr>
								...
								<td class="width-35">
									<div class="input-group date">
										<input id="time" class="form-control datetimeISO" name="time" type="text" value="${vo.time}" />
							...
							<tr>
								...
								<td colspan="3">
									<textarea id="describtion" class="form-control" name="describtion" maxlength="128" >${vo.describtion}</textarea>
								</td>	
							</tr>
						</tbody>
					</table>
					...
					<div class="form-group">
						<div class="col-sm-12 col-sm-offset-1">
							...
							<button class="btn btn-w-m btn-primary"  type="button" onclick="formSubmit('${fn:length(vo.id)>0? 'update4Data.do?isCommit=1':'add4Data.do?isCommit=1'}');">
								<i class="fa fa-check" aria-hidden="true"></i> 保存并提交
							</button>
