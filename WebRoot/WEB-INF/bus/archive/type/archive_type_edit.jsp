	...
	<div class="col-sm-12">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<ol class="breadcrumb">
					<li><a href="javascript:backMainPage();">档案分类</a></li>
					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							...
							<tr>
								...
								<td colspan="3">
									<textarea maxlength="128" id="describtion" placeholder="请输入文件说明" class="form-control" name="describtion" >${vo.describtion}</textarea>
								</td>	
							</tr>
						</tbody>
					</table>
