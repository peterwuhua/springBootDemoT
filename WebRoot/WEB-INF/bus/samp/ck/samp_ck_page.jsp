...
<body class="gray-bg">
	<div class="col-sm-12">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<div class="pull-left">
					<ol class="breadcrumb">
						<li><a href="gridPage.do">样品出库记录</a></li>
	...
	$(function() {
		var url ="";
		url = 'gridData.do';
		var colNames = ['任务编号','样品编号','客户名称','领用人','领用日期','领用数量','备注','状态','操作'];
		var colModel = [ 
			{
				name : 'taskVo.no',
				index : 'task.no',
				...
				searchoptions : {
					sopt : [ 'cn'],
					value:{'':'全部','SAMP_20':'待出库','SAMP_21':'已出库'}
				}
			},{
				name : 'act',
				index : 'act',
	...
	function formatStr(cellValue){
		if(cellValue=='SAMP_20'){
			return '待出库';
		}else if(cellValue=='SAMP_21'){
			return '已出库';
		}else{
			return '其他';
		}
