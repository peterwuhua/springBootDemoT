			...
			<div class="ibox-content">
				<form method="post"  class="form-horizontal" id="thisForm">
					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							<tr>
								<td class="width-15 active"><label class="pull-right">复&nbsp;核&nbsp;&nbsp;人:</label></td>
								<td>
									<input type="text" id="reptUser" name="reptUser" class="form-control" placeholder="复核人员" value="${vo.reptUser}"  readonly="readonly">
									<input type="hidden" name="reptUserId"  value="${vo.reptUserId}">
								</td>
								<td class="width-15 active"><label class="pull-right">复核日期:</label></td>
								<td>
									<div class="input-group date">
		                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		                              	<input id="reptDate" name="reptDate" class="form-control required datetimeISO" validate="required" placeholder="复核日期" type="text" value="${vo.reptDate}" />
		                            </div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<select class="form-control required" validate="required" id="auditUserId" name="auditUserId">
								...
								<td>
									<input id="reptMsg" name="reptMsg" class="form-control" type="text" value="${vo.reptMsg}" />
								</td>
							</tr>
					</table>
