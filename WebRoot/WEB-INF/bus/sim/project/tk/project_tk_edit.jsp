					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="input-group">
										...
										<input type="text" id="tkUserName" name="tkUserName" value="${vo.tkUserName}" class="form-control required" validate="required" placeholder="请选择" onclick="fnSelectUserPs()">
								...
								<td>
									<div class="input-group date">
										<input type="text" id="tkDate" name="tkDate" class="form-control datetimeISO required" validate="required" value="${vo.tkDate}">
							...
							<tr>
								...
								<td colspan="3">
									<textarea rows="2" class="form-control" id="tkMsg" name="tkMsg" maxlength="128">${vo.tkMsg}</textarea>
								</td>
							</tr> 
						</tbody>
					</table>
