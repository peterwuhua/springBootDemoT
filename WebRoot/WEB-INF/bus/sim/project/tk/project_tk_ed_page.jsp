...
<body class="gray-bg">
	...
	function fnShow(id,no){
		parent.layer.open({
			...
			fix: false, //不固定
			maxmin: true,
			content: '/bus/sim/projectTk/show4Surve.do?id='+id
		});
	}
	...
	function fnShowDW(id){
		POBrowser.openWindow('${basePath}bus/sim/projectTk/showDW.do?id='+id,'width=1200px;height=800px;');
	}
	function fnShowWl(id){
		POBrowser.openWindow('${basePath}bus/sim/projectTk/showWl.do?id='+id,'width=1200px;height=800px;');
	}
	function fnShowDC(id){
		POBrowser.openWindow('${basePath}bus/sim/projectTk/showDC.do?id='+id,'width=1200px;height=800px;');
	}
	</script>
</body>
</html>