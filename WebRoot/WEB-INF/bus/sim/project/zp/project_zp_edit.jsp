				...
				<form method="post" class="form-horizontal" id="thisForm" enctype="multipart/form-data">
					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							...
							<tr>
								<td class="active" rowspan="4" style="text-align: center;"><label>派<br>发<br>信<br>息</label></td>
								<th class="active"><label class="pull-right">上传资料:</label></th>
								<td ><input type="file" name="file" multiple="multiple" class="form-control" /></td>
								<td class="active"><label class="pull-right">任务人员:</label></td>
								<td>
									<div class="input-group">
										...
										<div class="input-group-btn">
											<button tabindex="-1" class="btn btn-primary" type="button" onclick="fnSelectUser()">多选</button>
										</div>
									</div>
								</td>
							</tr>
							...
							<tr>
								<td class="active"><label class="pull-right">派发人员:</label></td>
								<td>
										<input type="hidden" id="zpUserId" name="zpUserId" value="${vo.zpUserId}">
										<input type="text" id="zpUserName" name="zpUserName" value="${vo.zpUserName}" class="form-control "   readonly="readonly">
								</td>
								<td class="active"><label class="pull-right">派发日期:</label></td>
								<td>
										<input type="text" id="zpDate" name="zpDate" class="form-control  " value="${vo.zpDate}" readonly="readonly">
								</td>
							</tr>
							<tr>
								<td class="width-15 active"><label class="pull-right ">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注:</label></td>
								<td colspan="3">
									<textarea rows="2" class="form-control" id="zpMsg" name="zpMsg" maxlength="128">${vo.zpMsg}</textarea>
								</td>
							</tr> 
						</tbody>
					</table>
					...
					<div class="form-group">
						<div class="col-sm-12 col-sm-offset-1">
							<a class="btn btn-w-m btn-success" href="javascript:;" onclick="formSubmit('update4Data.do');"><i class="fa fa-check" aria-hidden="true"></i> 提交</a>
	...
	function removeFiles(id,obj){
		...
		function fnSelectUser(){
			...
			layer.open({
				...
				fix: false, //不固定
				maxmin: true,
				content: '${basePath}bus/sim/projectZp/user_select.do?ids='+userId+'&itemType='+encodeURI(itemType),
				btn: ['确定','取消'], //按钮
