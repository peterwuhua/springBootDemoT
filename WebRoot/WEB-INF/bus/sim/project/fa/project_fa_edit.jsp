				...
				<form method="post" class="form-horizontal" id="thisForm" enctype="multipart/form-data">
					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							...
							<tr>
							<td class="active" rowspan="4" style="text-align: center;"><label>方<br>案<br>信<br>息</label></td>
							...
							<tr>
								...
								<td>
										<input type="hidden" id="faUserId" name="faUserId" value="${vo.faUserId}">
										<input type="text" id="faUserName" name="faUserName" value="${vo.faUserName}" class="form-control "  readonly="readonly" >
								</td>
								<td class="active"><label class="pull-right">编制日期:</label></td>
								<td>
									<div class="input-group date">
										<input type="text" id="faDate" name="faDate" class="form-control datetimeISO required" validate="required" value="${vo.faDate}">
							...
							<tr>
								<td class="active"><label class="pull-right ">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注:</label></td>
								<td colspan="3"><textarea rows="3" class="form-control" id="faMsg" name="faMsg" maxlength="128">${vo.faMsg}</textarea></td>
							</tr>
						</tbody>
					</table>
	...
	function fnSelectUserPs(){
		...
		layer.open({
			...
			btn1: function(index, layero) {
			  ...
			  $('#faUserId').val(data.id);
			  $('#faUserName').val(data.name);
			}
		});
	}
	function formSubmit4Back(url){
		var auditJsResult=$('#faMsg').val();
		if(auditJsResult==''){
