				...
				<form method="post" class="form-horizontal" id="thisForm" enctype="multipart/form-data">
					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							...
							<tr>
								<td class="active" rowspan="4" style="text-align: center;"><label>编<br>制<br>信<br>息</label></td>	
							...
							<tr>
								...
								<td>
									<select class="form-control required" validate="required" id="auditUserId" name="auditUserId" onchange="setSHr(this);">
										<option value="">-请选择-</option>
										<c:forEach items="${userList}" var="e" varStatus="v">
										 	 <c:choose>
										 	 	<c:when test="${vo.auditUserId==e.id}">
									...
									<input type="hidden" id="auditUser" name="auditUser" value="${vo.auditUser}" >
								</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								<td class="active"><label class="pull-right">编制人员:</label></td>
								<td>
										<input type="hidden" id="makeUserId" name="makeUserId" value="${vo.makeUserId}">
										<input type="text" id="makeUser" name="makeUser" value="${vo.makeUser}" class="form-control "  readonly="readonly" >
								</td>
								<td class="active"><label class="pull-right">编制日期:</label></td>
								<td>
									<div class="input-group date">
										<input type="text" id="makeDate" name="makeDate" class="form-control datetimeISO required" validate="required" value="${vo.makeDate}">
							...
							<tr>
								<td class="active"><label class="pull-right ">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注:</label></td>
								<td colspan="3"><textarea rows="3" class="form-control" id="bzMsg" name="bzMsg" maxlength="128">${vo.bzMsg}</textarea></td>
							</tr>
						</tbody>
					</table>
					...
					<div class="form-group">
						<div class="col-sm-12 col-sm-offset-1">
							<a class="btn btn-w-m btn-success" type="button" onclick="fnSubmitSave('save4Data.do?isCommit=0')"><i class="fa fa-floppy-o" aria-hidden="true"></i> 保存</a>
