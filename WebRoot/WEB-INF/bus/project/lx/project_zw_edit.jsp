					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="input-group date">
										<input type="text" id="rdate" name="rdate"  class="form-control required" placeholder="请选择" validate="required" value="${vo.rdate}">
										 <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
									</div>
								</td>
								<td class="active"><label class="pull-right">项目频次:</label></td>
								<td>
									<input style="width: 90%; display: inline-block;" type="number" id="pc" name="pc"  class="form-control required digits" min="1" validate="required" value="${vo.pc}"  onchange="countFinishDay()">
							...
							<tr>
								...
								<td>
									<input style="width: 80%; display: inline-block;" type="number" id="cycle" name="cycle" min="1" class="form-control required digits" validate="required" value="${vo.cycle}" onchange="countFinishDay()">
									<select style="width: 18%; display: inline-block;" id="cycleUnit" name="cycleUnit"  class="form-control"  onchange="countFinishDay()">
										<c:choose>
