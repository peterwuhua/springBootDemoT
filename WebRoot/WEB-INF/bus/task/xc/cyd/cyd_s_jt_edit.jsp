			...
			<div class="ibox-content">
				<form method="post" action="updateTaskPoint.do" class="form-horizontal" id="thisForm">
					...
					<table style="margin-bottom: 5px;width: 100%">
						<tr>
							...
							<td style="padding: 2px;">
								<input id="deme2" name="deme2" value="${vo.deme2}" type="text" class="form-control" placeholder="m"/>
							</td>
						</tr>
						<tr>
					...
					<div style="overflow-x: auto;">
						<table class="table table-bordered" style="margin-bottom: 0px; min-width:1500px">
							<thead>
								<tr>
									...
									<th rowspan="2" width="100px">昼夜类型</th>
									<th colspan="2">校准示值</th>
									<th colspan="6">数据  dB(A)</th>
									<th width="80px" rowspan="2">标准偏差SD</th>
									<th width="80px" rowspan="2">测点高度</th>
								...
								<tr>
									...
									<th width="80px">前</th>
									<th width="80px">后</th>
									<th width="80px">Leq</th>
									<th width="80px">L10</th>
									<th width="80px">L50</th>
									<th width="80px">L90</th>
									<th width="80px">Lmax</th>
									<th width="80px">Lmin</th>
									<th width="80px">重型车</th>
									<th width="80px">中型车</th>
									<th width="80px">轻型车</th>
								</tr>
							</thead>
							<tbody id="samp_tb">
								<c:forEach items="${vo.sampList}" var="e" varStatus="v">
									<tr>
										<td align="center">
								 		...
								 		<td>
								 			<div class="input-group" style="width: 100%">
									 			<input type="text" class="form-control" name="sampList[${v.index}].recordVo.demo11" value="${e.recordVo.demo11}">
									 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyVals(this,${v.index});return false;"></span>
								 			</div>
								 		</td>
								 		<td>
								 			<div class="input-group" style="width: 100%">
									 			<input type="text" class="form-control" name="sampList[${v.index}].recordVo.demo12" value="${e.recordVo.demo12}">
									 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyVals(this,${v.index});return false;"></span>
								 			</div>
								 		</td>
								 		<td>
								 			<div class="input-group" style="width: 100%">
									 			<input type="text" class="form-control" name="sampList[${v.index}].recordVo.demo13" value="${e.recordVo.demo13}">
									 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyVals(this,${v.index});return false;"></span>
								 			</div>
								 		</td>
								 		<td>
								 			<div class="input-group" style="width: 100%">
									 			<input type="text" class="form-control" name="sampList[${v.index}].recordVo.demo14" value="${e.recordVo.demo14}">
									 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyVals(this,${v.index});return false;"></span>
								 			</div>
								 		</td>
									</tr>
