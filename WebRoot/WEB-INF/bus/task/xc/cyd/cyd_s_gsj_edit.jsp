				...
				<form method="post" action="updateTaskPoint.do" class="form-horizontal" id="thisForm">
					...
					<table style="margin-bottom: 5px;width: 100%">
						<tr>
							...
							<td style="width: 23%;padding: 2px;">
								<input id="deme2" name="deme2" value="${vo.deme2}" type="text" class="form-control" placeholder="B（A）"/>
							</td>
							<td style="width: 10%;text-align: right;">测定范围：</td>
							<td style="padding: 2px;">
								<input id="deme3" name="deme3" value="${vo.deme3}" type="text" class="form-control" placeholder="B（A）"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="text-align: right;">功能区类别：</td>
							<td style="padding: 2px;">
								<select  id="gnq" name="gnq"  class="form-control">
							...
							<thead>
								<tr>
									...
									<th  width="110px">主要声源</th>
									 <th width="100px">测量开<br>始时间</th>
									<th width="100px">测量结<br>束时间</th>
