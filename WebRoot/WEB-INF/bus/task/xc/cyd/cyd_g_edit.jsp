				...
				<form method="post" action="updateTaskPoint.do" class="form-horizontal" id="thisForm">
					...
					<table style="margin-bottom: 5px;width: 100%">
						...
						<tr>
							...
							<td style="padding: 2px;">
								<input id="deme2" name="deme2" value="${vo.deme2}" type="text" class="form-control"/>
							</td>
							<td style="text-align: right;">调&nbsp;查&nbsp;&nbsp;船：</td>
							<td style="padding: 2px;">
								<input id="deme3" name="deme3" value="${vo.deme3}" type="text" class="form-control"/>
							</td>
							<td style="text-align: right;">固废类别：</td>
							<td style="padding: 2px;">
								<input id="deme4" name="deme4" value="${vo.deme4}" type="text" class="form-control" placeholder="固废（废液）类别"/>
							</td>
						</tr>
						<tr>
							...
							<td style="padding: 2px;">
								<input id="deme5" name="deme5" value="${vo.deme5}" type="text" class="form-control"/>
							</td>
							<td style="text-align: right;">污染状况：</td>
							<td style="padding: 2px;">
								<input id="deme6" name="deme6" value="${vo.deme6}" type="text" class="form-control" placeholder="周 围 环 境 及污 染 状 况"/>
							</td>
						</tr>
						<tr>
							...
							<td style="padding: 2px;">
								<input id="xcDesc" name="xcDesc" value="${vo.xcDesc}" type="text" class="form-control" placeholder="废物存放及现场采样情况说明(企业生产工况)" />
							</td>
