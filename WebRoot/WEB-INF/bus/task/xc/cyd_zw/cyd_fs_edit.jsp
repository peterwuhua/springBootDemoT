				...
				<form method="post" action="updateTaskPoint.do" class="form-horizontal" id="thisForm">
					...
					<table style="margin-bottom: 5px;width: 100%">
						...
						<tr>	
							...
							<td style="padding: 2px;">
								<input id="deme4" name="deme4" value="${vo.deme4}" type="text" class="form-control" placeholder=""/>
							</td>
							<td style="text-align: right;">测量参数：</td>
							<td style="padding: 2px;">
								<input id="deme5" name="deme5" value="${vo.deme5}" type="text" class="form-control" placeholder=""/>
							</td>
							<td style="text-align: right;">测量本底：</td>
							<td style="padding: 2px;">
								<input id="deme6" name="deme6" value="${vo.deme6}" type="text" class="form-control" placeholder=""/>
							</td>
						</tr>
						<tr>	
							<td style="text-align: right;">测试工况：</td>
							<td style="padding: 2px;">
								<input id="deme7" name="deme7" value="${vo.deme7}" type="text" class="form-control" placeholder=""/>
							</td>
						</tr>
					</table>
