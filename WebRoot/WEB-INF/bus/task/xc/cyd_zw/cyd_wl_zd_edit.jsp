							...
							<c:forEach items="${vo.sampList}" var="e" varStatus="v">
								<tr>
							 		<td>
							 			...
							 			<input style="text-align: center;" type="text" class="form-control" name="sampList[${v.index}].sampCode" value="${e.sampCode}" >
							 		</td>
							 		<td>
							 			${e.pointVo.room}
							 		</td>
						    		<td>
							 		...
							 		<td>
							 		   <input style="text-align: center;" type="text" class="form-control" name="sampList[${v.index}].recordVo.demo1" value="${e.recordVo.demo1}" >
							 		</td>
							 		<td>
							 		   <input style="text-align: center;" type="text" class="form-control" name="sampList[${v.index}].recordVo.demo2" value="${e.recordVo.demo2}" >
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
							 		...
							 		<td>
							 			<div class="input-group" style="width: 100%">
							 			   <input type="text" id="ahw_${v.index}"  class="form-control "  name="sampList[${v.index}].recordVo.avg1" value="${e.recordVo.avg1}">
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
							 			   <input type="text" id="ahw4_${v.index}" class="form-control "  name="sampList[${v.index}].recordVo.avg2" value="${e.recordVo.avg2}">
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
...
function countAwh(index){
	...
	ahw4=ahw*Math.sqrt(wh/4)
	$('#ahw4_'+index).val(fmtVal(ahw4,2));
}
//格式化计算结果保留n个有效数字
