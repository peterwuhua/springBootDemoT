					...
					<table class="table table-bordered" style="margin-bottom: 0px;">
						<thead>
							<tr>
								...
								<th rowspan="3" width="7%">车间/岗位</th>
								<th rowspan="3" width="7%">检测点/检测对象</th>
								<th rowspan="3" width="80">型号频率</th>
								<th rowspan="3" width="80">测量时间</th>
								<th rowspan="3" width="90">测量部位</th>
								<th rowspan="3" width="80">工人巡检停留时间/巡检次数</th>
								<th rowspan="3" width="80">接触时间(h/d)</th>
								<th rowspan="3" width="80">脉冲波</th>
								<th rowspan="3" width="80">连续波</th>
								<th colspan="6" >短时间接触功率密度（μW/cm2 ）</th>
								<th rowspan="3" >备注</th>
							</tr>
							<tr>
							  	<th colspan="3" >测量值</th>
