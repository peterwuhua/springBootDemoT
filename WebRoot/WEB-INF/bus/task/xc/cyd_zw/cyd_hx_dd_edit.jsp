				...
				<form method="post" action="updateTaskPoint.do" class="form-horizontal" id="thisForm">
					...
					<table style="margin-bottom: 5px;width: 100%">
						...
						<tr>
							...
							<td style="padding: 2px;">
								<select style="width: 100%" id="cyAppId" name="cyAppId" data-placeholder="请选择" class="chosen-select form-control"  multiple>
					...
					<table class="table table-bordered" style="margin-bottom: 0px;">
						<thead>
							<tr>
								...
								<th rowspan="2" width="100">车间/岗位</th>
								<th rowspan="2" width="120">检测点</th>
								<th rowspan="2" width="80">工人巡检<br>停留时间<br>/巡检次数</th>
								<th rowspan="2" width="80">接触时间</th>
								<th colspan="2">采样流量（L/min）</th>
								<th colspan="2">采样时间</th>
								<th rowspan="2" width="80">采样体积（L）</th>
								<th rowspan="2" width="80">标准体积（L）</th>
							<!-- 	<th rowspan="2" width="100">采样前滤膜质量(mg)</th>
								<th rowspan="2" width="100">采样后滤膜质量(mg)</th> -->
						...
						<tbody id="samp_tb">
							<c:forEach items="${vo.sampList}" var="e" varStatus="v">
								<tr>
							 		...
							 		<!-- <td>
							 			<div class="input-group" style="width: 100%">
								 			<input type="text" class="form-control" name="sampList[${v.index}].v1" value="${e.v1}">
								 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyVals(this,${v.index});return false;"></span>
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input type="text" class="form-control" name="sampList[${v.index}].v2" value="${e.v2}">
								 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyVals(this,${v.index});return false;"></span>
							 			</div>
							 		</td> -->
							 		<td>
