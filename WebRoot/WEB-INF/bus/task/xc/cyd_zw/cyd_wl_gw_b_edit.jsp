...
<body style="overflow: auto;">
	<div class="col-sm-12" style="min-width: 1500px;">
					...
					<table class="table table-bordered" style="margin-bottom: 0px;">
						<thead>
							<tr>
								...
								<th rowspan="3" >检测岗位/检测车间</th>
								<th rowspan="3" >检测点</th>
								<th rowspan="3" width="80">作业人员巡检停留时间(min/次)×巡检次数</th>
								<th rowspan="3" width="80">测量时间</th>
								<th rowspan="3" width="80">接触时间(min)</th>
							...
							<c:forEach items="${vo.sampList}" var="e" varStatus="v">
								<tr>
						    		...
						    		<td>
							 		...
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="val_${v.index}_1_1" type="text" class="form-control "  name="sampList[${v.index}].recordVo.v1" value="${e.recordVo.v1}" onchange="countVal(1,${v.index});">
							 		...
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="val_${v.index}_1_2" type="text" class="form-control "  name="sampList[${v.index}].recordVo.v2" value="${e.recordVo.v2}" onchange="countVal(1,${v.index});">
								 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyCtVals(this,1);return false;"></span>
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="val_${v.index}_1_3" type="text" class="form-control "  name="sampList[${v.index}].recordVo.v3" value="${e.recordVo.v3}" onchange="countVal(1,${v.index});">
								 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyCtVals(this,1);return false;"></span>
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="value_${v.index}_1" type="text" class="form-control "  name="sampList[${v.index}].recordVo.avg1" value="${e.recordVo.avg1}">
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="val_${v.index}_2_1" type="text" class="form-control "  name="sampList[${v.index}].recordVo.v4" value="${e.recordVo.v4}" onchange="countVal(2,${v.index});">
							 		...
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="val_${v.index}_2_2" type="text" class="form-control "  name="sampList[${v.index}].recordVo.v5" value="${e.recordVo.v5}" onchange="countVal(2,${v.index});">
								 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyCtVals(this,2);return false;"></span>
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="val_${v.index}_2_3" type="text" class="form-control "  name="sampList[${v.index}].recordVo.v6" value="${e.recordVo.v6}" onchange="countVal(2,${v.index});">
								 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyCtVals(this,2);return false;"></span>
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="value_${v.index}_2" type="text" class="form-control "  name="sampList[${v.index}].recordVo.avg2" value="${e.recordVo.avg2}">
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="val_${v.index}_3_1" type="text" class="form-control "  name="sampList[${v.index}].recordVo.v7" value="${e.recordVo.v7}" onchange="countVal(3,${v.index});">
							 		...
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="val_${v.index}_3_2" type="text" class="form-control "  name="sampList[${v.index}].recordVo.v8" value="${e.recordVo.v8}" onchange="countVal(3,${v.index});">
								 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyCtVals(this,3);return false;"></span>
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="val_${v.index}_3_3" type="text" class="form-control "  name="sampList[${v.index}].recordVo.v9" value="${e.recordVo.v9}" onchange="countVal(3,${v.index});">
								 			<span style="display: table-cell;" class=" btn btn-xs glyphicon glyphicon-arrow-down" aria-hidden="true" onclick="copyCtVals(this,3);return false;"></span>
							 			</div>
							 		</td>
							 		<td>
							 			<div class="input-group" style="width: 100%">
								 			<input id="value_${v.index}_3" type="text" class="form-control "  name="sampList[${v.index}].recordVo.avg3" value="${e.recordVo.avg3}">
							 			</div>
							 		</td>
								</tr>
							</c:forEach>
