					...
					<table class="table table-bordered" style="margin-bottom: 0px;">
						<thead>
							<tr>
								...
								<th rowspan="3" width="110">检测岗位车间/装置</th>
								<th rowspan="3" width="110">检测点</th>
								<th rowspan="3" width="90">工人巡检停留时间/巡检次数</th>
								<th rowspan="3" width="90">接触时间率(%)</th>
							...
							<tr>
								<th width="100">湿球温度</th>
								<th width="100">黑球温度</th>
								<th width="100">干球温度</th>
								<th width="100">WBGT指数</th>
								<th width="100">湿球温度</th>
								<th width="100">黑球温度</th>
								<th width="100">干球温度</th>
								<th width="100">WBGT指数</th>
