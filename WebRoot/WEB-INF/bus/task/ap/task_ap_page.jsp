...
<body class="gray-bg">
			...
			<div class="ibox-content">
				<form action="gridPage.do" method="post" id="listForm">
					...
					<div>
						...
						<!-- <a class="btn btn-primary" href="javascript:;" onclick="fnEdit();"><i class="fa fa-pencil-square-o" aria-hidden="true"> 批量安排</i></a> -->
					</div>
	...
	$(function() {
		var url = 'gridData.do';
		var colNames = ['任务编号','受检单位','样品名称','检测类型','受理日期','要求完成日期','操作'];
		var colModel = [ 
			{
				name : 'no',
				index : 'no',
	...
	function fnTaskLx(id,no){
		parent.layer.open({
			...
			fix: false, //不固定
			maxmin: true,
			content: '/bus/lxPlan/show.do?id='+id
		});
	}
	</script>
</body>
