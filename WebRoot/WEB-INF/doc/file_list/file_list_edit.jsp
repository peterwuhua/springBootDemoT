...
<body class="gray-bg">
                        ...
                        <form method="post" action="" class="form-horizontal">
                            <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
								<tbody>
									...
									<tr>
										...
										<td class="width-35" colspan="2">${vo.describtion}</td>
									</tr>
								</tbody>
							</table>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 col-sm-offset-1">
									<a href="javascript:backMainPage();" class="btn btn-w-m btn-white" onclick="">返回</a>
                                </div>
                           </div>
                        </form>
                    </div>
    ...
    <script type="text/javascript">
    	function goBack(){
    		location.href='gridData.do?pid='+${vo.pid};
    	}
    </script>
</body>
</html>
